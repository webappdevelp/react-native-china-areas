          ...
          <View style={styles.container}>
            ...
            <ScrollView style={styles.list}>
              {this.state.provincesList.map(rowData => {
                return <Text style={styles.listItem} key={rowData.id} onPress={this.handleProvinceChange.bind(this, rowData.id)}>{ rowData.name }</Text>
              })}
            </ScrollView>
          </View>
        </View>
          ...
          <View style={styles.container}>
            ...
            <ScrollView style={styles.list}>
              {this.state.citysList.map(rowData => {
                return <Text style={styles.listItem} key={rowData.id} onPress={this.handleCityChange.bind(this, rowData.id)}>{ rowData.name }</Text>
              })}
            </ScrollView>
          </View>
        </View>
          ...
          <View style={styles.container}>
            ...
            <ScrollView style={styles.list}>
              {this.state.areasList.map(rowData => {
                return <Text style={styles.listItem} key={rowData.id} onPress={this.handleAreaChange.bind(this, rowData.id)}>{ rowData.name }</Text>
              })}
            </ScrollView>
          </View>
        </View>
