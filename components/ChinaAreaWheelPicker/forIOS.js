      ...
      <View style={styles.overlayStyle}>
        <View style={styles.pickerContainer}>
          <View style={styles.pickerNavWrap}>
            <View isHandlerPress={true} onPress={this.handleCancel} style={styles.btn}>
              <Text style={styles.btnText}>取消</Text>
            </View>
            <View isHandlerPress={true} onPress={this.handleSubmit} style={styles.btn}>
          ...
          <View style={styles.pickerWrap}>
            ...
            >
              { this.state.provinces.map((province, index) => {
                return <Picker.Item value={province.id} label={ province.name } key={index} />
              })}
            </Picker>
            <Picker
            ...
            >
              { this.state.citys.map((city, index) => {
                return <Picker.Item value={city.id} label={city.name} key={index} />
              })}
            </Picker>
            <Picker
            ...
            >
              { this.state.areas.map((area, index) => {
                return <Picker.Item value={area.id} label={area.name} key={index} />
              })}
            </Picker>
          </View>
        </View>
